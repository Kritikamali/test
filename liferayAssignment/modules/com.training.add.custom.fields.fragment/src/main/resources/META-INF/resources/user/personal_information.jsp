...
<clay:row>
	...
	>
		...
		<div>
			<aui:input label="Office ID" name="officeID" type="text" />

			<aui:input label="Office Designation" name="officeDesignation" type="text" />

			<aui:input label="Office Location" name="officeLocation" type="text" />

			<aui:input label="Reporting To" name="reportingTo" type="text" />
		</div>
